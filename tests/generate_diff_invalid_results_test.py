...
def test_invalid_file_path():
    # Тест на обработку ошибки при передаче некорректного пути к файлу
...
def test_invalid_file_path_2():
    # Тест на обработку ошибки при передаче некорректного пути к файлу
    with pytest.raises(FileNotFoundError):
        generate_diff("nonexistent_file1.yml", "nonexistent_file2.yml", format_name='yml')


def test_invalid_json_format():
    # Тест на обработку ошибки при передаче некорректного JSON-файла
...
def test_invalid_yml_format():
    # Тест на обработку ошибки при передаче некорректного YAML-файла
